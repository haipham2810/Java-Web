                    ...
                    <section>
                        <div class="container py-5">
                            <div class="row">
                                ...
                                <div class="col-lg-8 ">
                                    <form action="UpdateBook" method="POST" class="card mb-4" enctype="multipart/form-data">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input  name="avtFile" type="file" accept="image/*"/>
                                                </div>
                                            </div>
                                            <input  name="avt" type="hidden" value="${book.img}"/>
                                        </div>
                                        <input style="width: 20%" type="submit" class="btn btn-primary" value="Update Book"></input>
                                    </form>
