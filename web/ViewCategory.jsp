    ...
    <body class="sb-nav-fixed" style="overflow-x: hidden">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div>
                ...
                <a href="AddCategoryNew" type="button" class="btn btn-primary">Add Category</a>
            </div>
                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listCategory}" var="i">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="i" href="DeleteCategory?id=${i.category_id}" dclass="table-link danger" style="text-decoration: none; color: red;" 
                                                           title="Detele Category" onclick="return confirm('Are you sure Detele Category ${i.category_id}?');">
                                                            <span class="fa-stack">
                                        ...
                                        <c:forEach begin="1" end="${numberOfPage}" var="i">
                                            <c:if test="${i== page}">
                                                <li class="page-item active" aria-current="page">
                                                    <a class="page-link" href="ListCategory?page=${i}">${i}</a>
                                                </li>
                                            </c:if>
                                            <c:if test="${i!= page}">
                                                <li class="page-item"><a class="page-link" href="ListCategory?page=${i}">${i}</a></li>
                                                </c:if>
