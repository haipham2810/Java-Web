                                        ...
                                        <tbody>
                                            <c:forEach items="${requestScope.listBook}" var="i">
                                                <tr>
                                                    ...
                                                    <td>${i.author}</td>
                                                    <td>${mapCategory.get(i.category).category_name}</td>
                                                    <td>${i.language}</td>
                                                    <td>${i.total}</td>
                                                    <td>${i.current}</td>
                                                    <td>${i.position}</td>
                                                    <td>
                                                        ...
                                                        <a href="DeleteBook?id=${i.bookid}" class="table-link danger" style="text-decoration: none;" 
                                                           title="Detele Book" onclick="return confirm('Are you sure Detele Book ${i.bookid}?');">
                                                            <span class="fa-stack">
